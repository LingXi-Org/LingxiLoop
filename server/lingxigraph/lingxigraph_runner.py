        ...
        "actions": {
            ...
            "items": {
                "oneOf": [
                    ...
                    {"type": "object", "additionalProperties": False, "required": ["type", "conversationId", "kind", "summary", "payload"], "properties": {"type": {"const": "approval.request"}, "conversationId": {"type": "string", "minLength": 1}, "kind": {"type": "string", "enum": ["external_communication", "sensitive_or_destructive_action", "financial_or_irreversible_action"]}, "summary": {"type": "string", "minLength": 1}, "payload": {"type": "object"}}},
