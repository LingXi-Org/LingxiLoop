...
export const IPYTHON_TOOL: DeepSeekFunctionTool = {
  ...
  function: {
    name: 'ipython',
    description: 'Execute Python in your persistent per-agent IPython session. Use the preloaded loop SDK for chat, memory, files, documents, boards, calendar, routines, research, computer, email, polls, and turn control.',
    parameters: {
      type: 'object',
      properties: {
        code: {
