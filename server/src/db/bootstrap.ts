...
const REQUIRED_V1_RELATIONS = [
  ...
  'im_read_receipt_advances', 'im_send_acceptances', 'knowledge_notebook_bindings',
  'knowledge_source_jobs', 'knowledge_sources',
  ...
  'organization_seats', 'organization_units', 'participants', 'plan_entitlements', 'plans', 'project_memberships',
  'presentation_evidence', 'presentation_jobs', 'presentation_pages', 'presentation_versions', 'presentations',
...
const FORBIDDEN_V1_COLUMNS = [
  ...
  ['conversation_source_exclusions', 'created_by'],
...
const REQUIRED_V1_COLUMNS = [
  ...
  ['conversation_source_exclusions', 'user_id'],
  ...
  ['organization_units', 'status'],
  ['organization_units', 'version'],
  ['governance_policies', 'kind'],
  ['governance_policies', 'policy_version'],
  ['governance_policies', 'config'],
  ['governance_policies', 'revision'],
  ...
  ['trust_snapshots', 'audience_level'],
  ['trust_snapshots', 'payload_hash'],
  ['trust_snapshots', 'signature'],
  ['trust_snapshots', 'evidence_id'],
  ['knowledge_sources', 'visibility_scope'],
  ['knowledge_sources', 'owner_user_id'],
  ['knowledge_sources', 'created_by_user_id'],
  ['knowledge_sources', 'created_via'],
  ...
  ['presentations', 'visibility_scope'],
  ['presentations', 'source_snapshot'],
  ['presentations', 'outline_revision'],
  ['presentations', 'latest_version_id'],
  ['presentation_jobs', 'stage'],
  ['presentation_jobs', 'checkpoint'],
  ['presentation_jobs', 'lease_fence'],
  ['presentation_jobs', 'idempotency_key'],
  ['presentation_evidence', 'chunk_id'],
  ['presentation_evidence', 'excerpt'],
  ['presentation_evidence', 'claim'],
  ['presentation_evidence', 'position'],
  ['presentation_pages', 'content_ir'],
  ['presentation_pages', 'slide_spec'],
  ['presentation_pages', 'quality_issues'],
  ['presentation_versions', 'storage_key'],
  ['presentation_versions', 'sha256'],
  ['presentation_versions', 'manifest'],
  ['presentation_versions', 'quality_report'],
] as const
...
const REQUIRED_V1_NOT_NULL_COLUMNS = [
  ...
  ['conversation_source_exclusions', 'user_id', null],
  ...
  ['knowledge_sources', 'visibility_scope', null],
  ['knowledge_sources', 'owner_user_id', null],
  ['knowledge_sources', 'created_by_user_id', null],
  ['knowledge_sources', 'created_via', null],
  ['presentations', 'company_id', null],
  ['presentations', 'project_id', null],
  ['presentations', 'conversation_id', null],
  ['presentations', 'authorization_user_id', null],
  ['presentations', 'visibility_scope', null],
  ['presentations', 'source_snapshot', "'[]'::jsonb"],
  ['presentations', 'outline_revision', '0'],
  ['presentations', 'status', "'waitingForSources'::text"],
  ['presentation_jobs', 'company_id', null],
  ['presentation_jobs', 'presentation_id', null],
  ['presentation_jobs', 'status', "'queued'::text"],
  ['presentation_jobs', 'stage', "'waitingForSources'::text"],
  ['presentation_jobs', 'checkpoint', "'{}'::jsonb"],
  ['presentation_jobs', 'attempts', '0'],
  ['presentation_jobs', 'lease_fence', '0'],
  ['presentation_jobs', 'idempotency_key', null],
  ['presentation_evidence', 'company_id', null],
  ['presentation_evidence', 'presentation_id', null],
  ['presentation_evidence', 'source_id', null],
  ['presentation_evidence', 'excerpt', null],
  ['presentation_evidence', 'claim', null],
  ['presentation_evidence', 'position', "'{}'::jsonb"],
  ['presentation_pages', 'company_id', null],
  ['presentation_pages', 'presentation_id', null],
  ['presentation_pages', 'revision', '1'],
  ['presentation_pages', 'quality_issues', "'[]'::jsonb"],
  ['presentation_pages', 'status', "'planned'::text"],
  ['presentation_versions', 'company_id', null],
  ['presentation_versions', 'presentation_id', null],
  ['presentation_versions', 'storage_key', null],
  ['presentation_versions', 'sha256', null],
  ['presentation_versions', 'manifest', null],
  ['presentation_versions', 'quality_report', null],
] as const
...
const REQUIRED_V1_PRIMARY_KEYS = [
  ...
  ['context_threads', ['id']],
  ['conversation_source_exclusions', ['conversation_id', 'source_id', 'user_id']],
  ...
  ['entitlements', ['id']],
  ['presentations', ['id']],
  ['presentation_jobs', ['id']],
  ['presentation_evidence', ['id', 'company_id', 'presentation_id']],
  ['presentation_pages', ['id', 'company_id', 'presentation_id']],
...
const REQUIRED_V1_CONSTRAINTS = [
  ...
  ['conversation_source_exclusions', 'conversation_source_exclusions_user_id_fkey', 'f'],
  ...
  ['organization_units', 'organization_units_scope_key', 'u'],
  ['organization_units', 'organization_units_company_fkey', 'f'],
  ['organization_units', 'organization_units_parent_fkey', 'f'],
  ['organization_units', 'organization_units_creator_fkey', 'f'],
  ['organization_units', 'organization_units_updater_fkey', 'f'],
  ['organization_units', 'organization_units_name_check', 'c'],
  ['organization_units', 'organization_units_status_check', 'c'],
  ['organization_units', 'organization_units_parent_check', 'c'],
  ['organization_units', 'organization_units_version_check', 'c'],
  ['governance_policies', 'governance_policies_company_kind_key', 'u'],
  ['governance_policies', 'governance_policies_company_fkey', 'f'],
  ['governance_policies', 'governance_policies_creator_fkey', 'f'],
  ['governance_policies', 'governance_policies_updater_fkey', 'f'],
  ['governance_policies', 'governance_policies_kind_check', 'c'],
  ['governance_policies', 'governance_policies_version_check', 'c'],
  ['governance_policies', 'governance_policies_config_check', 'c'],
  ['governance_policies', 'governance_policies_revision_check', 'c'],
  ...
  ['knowledge_sources', 'knowledge_sources_visibility_scope_check', 'c'],
  ['knowledge_sources', 'knowledge_sources_created_via_check', 'c'],
  ['knowledge_sources', 'knowledge_sources_id_company_id_key', 'u'],
  ['knowledge_sources', 'knowledge_sources_project_company_fkey', 'f'],
  ['knowledge_sources', 'knowledge_sources_conversation_scope_fkey', 'f'],
  ['knowledge_sources', 'knowledge_sources_owner_user_id_fkey', 'f'],
  ['knowledge_sources', 'knowledge_sources_created_by_user_id_fkey', 'f'],
  ['presentations', 'presentations_scope_key', 'u'],
  ['presentations', 'presentations_visibility_scope_check', 'c'],
  ['presentations', 'presentations_status_check', 'c'],
  ['presentations', 'presentations_project_company_fkey', 'f'],
  ['presentations', 'presentations_conversation_scope_fkey', 'f'],
  ['presentations', 'presentations_authorization_user_fkey', 'f'],
  ['presentations', 'presentations_latest_version_fkey', 'f'],
  ['presentation_jobs', 'presentation_jobs_idempotency_key', 'u'],
  ['presentation_jobs', 'presentation_jobs_status_check', 'c'],
  ['presentation_jobs', 'presentation_jobs_presentation_fkey', 'f'],
  ['presentation_evidence', 'presentation_evidence_presentation_fkey', 'f'],
  ['presentation_evidence', 'presentation_evidence_source_fkey', 'f'],
  ['presentation_pages', 'presentation_pages_page_key', 'u'],
  ['presentation_pages', 'presentation_pages_presentation_fkey', 'f'],
  ['presentation_versions', 'presentation_versions_number_key', 'u'],
  ['presentation_versions', 'presentation_versions_storage_key_key', 'u'],
  ['presentation_versions', 'presentation_versions_presentation_fkey', 'f'],
  ['trust_snapshots', 'trust_snapshots_scope_key', 'u'],
  ['trust_snapshots', 'trust_snapshots_audience_check', 'c'],
  ['trust_snapshots', 'trust_snapshots_payload_check', 'c'],
  ['trust_snapshots', 'trust_snapshots_hash_check', 'c'],
  ['trust_snapshots', 'trust_snapshots_signature_check', 'c'],
  ['trust_snapshots', 'trust_snapshots_project_fkey', 'f'],
  ['trust_snapshots', 'trust_snapshots_evidence_fkey', 'f'],
  ['trust_snapshots', 'trust_snapshots_creator_fkey', 'f'],
...
const REQUIRED_V1_INDEXES = [
  ...
  'idx_organization_units_parent',
  'idx_project_transfers_status',
  'idx_knowledge_sources_project',
  'idx_knowledge_sources_private_owner',
  'idx_presentations_detail',
  'idx_presentations_project_status',
  'uniq_presentations_artifact_message',
  'idx_presentation_jobs_claim',
  'idx_presentation_jobs_presentation',
  'idx_presentation_evidence_source',
  'idx_presentation_pages_order',
  'idx_presentation_versions_history',
  'idx_trust_snapshots_project_created',
