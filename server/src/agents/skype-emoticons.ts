...
export const SKYPE_EMOTICONS_GUIDE =
  'SKYPE EMOTICONS — LingxiLoop renders classic Skype emoticons inline (animated, transparent) anywhere you type a `(name)` shortcode in a reply body. They\'re the kind of expressive flourish that makes chat feel human; use them when a regular emoji wouldn\'t quite land, NOT in every message. Stay sparing — one per reply, max.\n' +
