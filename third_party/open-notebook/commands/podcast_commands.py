...
from open_notebook.podcasts.audio_paths import persist_audio_file
...
async def generate_podcast_command(
    ...
    try:
        ...
        # Persist final audio to private R2 when configured. Local mode retains
        # the safe path-relative representation used by upstream.
        audio_file_rel = (
            await asyncio.to_thread(persist_audio_file, raw_audio_path)
            if raw_audio_path
            else None
        )
