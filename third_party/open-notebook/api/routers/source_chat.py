...
class CreateSourceChatSessionRequest(BaseModel):
    ...
    notebook_id: str = Field(..., description="Notebook that owns the source")
...
async def verify_source_notebook_scope(notebook_id: str, source_id: str) -> None:
...
async def create_source_chat_session(
    ...
    try:
        ...
        await verify_source_notebook_scope(request.notebook_id, full_source_id)
