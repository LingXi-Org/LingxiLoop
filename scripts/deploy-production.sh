...
for secret in POSTGRES_USER POSTGRES_PASSWORD POSTGRES_DB DATABASE_URL \
  ...
  LINGXI_IDENTITY_ISSUER LINGXI_IDENTITY_CLIENT_ID LINGXI_IDENTITY_CLIENT_SECRET \
  LINGXILOOP_AUTH_DONE_URL LINGXILOOP_INVITE_BASE_URL LINGXILOOP_PLATFORM_ADMIN_EMAILS; do
