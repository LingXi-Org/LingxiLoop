/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/control-plane/wrangler.jsonc` (hash: 9f3a017461be572b3218b68a8c49d935)
// Runtime types generated with workerd@1.20260828.1 2026-09-01 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ASSETS: Fetcher;
	ORIGIN_BASE_URL: "https://origin.loop.lingxilearn.cn";
	OPENSHIP_BASE_URL: "https://ops.lingxilearn.cn";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ORIGIN_BASE_URL" | "OPENSHIP_BASE_URL" | "AUTH_ALLOWED_HOSTS" | "APP_VERSION">> {}
}
